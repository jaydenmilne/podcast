	...
	Channel: Podcast{
		...
		PodcastTrailers: []PodcastTrailer{
			PodcastTrailer{
				...
				TrailerTitle: "Coming April 1st, 2021",
		...
		PodcastLicense: &PodcastLicense{
			...
			LicenseID: "my-podcast-license-v1",
